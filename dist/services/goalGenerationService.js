...
exports.getMotivationalMessage = exports.updateGoalProgress = exports.generateWeeklyGoals = exports.generateDailyGoals = void 0;
 ...
 */
const generateDailyGoals = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield prismaClient_1.default.studentGoal.deleteMany({
            where: {
                userId: userId,
                goalType: 'daily',
        ...
        yield prismaClient_1.default.studentGoal.createMany({
            data: goalsData
        });
        // Fetch back the created goals to return them (since createMany doesn't return the full objects in all DBs)
        const savedGoals = yield prismaClient_1.default.studentGoal.findMany({
            where: {
                userId: userId,
                goalType: 'daily',
                dueDate: { gte: today, lt: tomorrow },
 ...
 */
const generateWeeklyGoals = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield prismaClient_1.default.user.findUnique({
            where: { id: userId }
        });
 ...
 */
const calculateDifficultyLevel = (performance) => {
    if (!performance)
        return 'intermediate';
 ...
 */
const getWeakAreaSuggestion = (performance) => {
    if (!performance || !performance.weakTopics || performance.weakTopics.length === 0) {
 ...
 */
const getTopicAccuracy = (performance, topic) => {
    if (!performance)
        return 0;
 ...
 */
const updateGoalProgress = (goalId, progressIncrement) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
const getMotivationalMessage = (performance, goalType) => {
    const messages = {
        high_performance: [
